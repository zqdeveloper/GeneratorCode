...
public class SysFileController {
  ...
  public Result insert(@RequestBody SysFile sysFile) {
    try {
      return sysFileService.insertSysFile(sysFile);
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public Result deleteByIds(@RequestBody String ids) {
    try {
      return sysFileService.deleteByIds(ids);
    } catch (Exception e) {
      e.printStackTrace();
                return new Result(Constant.FAIL_, Constant.ADD_MESSAGE_FAIL, null);
    }
  ...
  @ResponseBody
  @RequestMapping("/list")
  public PageResult list(@RequestBody SysFile sysFile) {
    try {
      return sysFileService.list(sysFile);
    } catch (Exception e) {
