...
public class XxlJobInfoController {
  ...
  public Result insert(@RequestBody XxlJobInfo xxlJobInfo) {
    try {
      return xxlJobInfoService.insertXxlJobInfo(xxlJobInfo);
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public Result update(@RequestBody XxlJobInfo xxlJobInfo) {
    try {
      return xxlJobInfoService.updateXxlJobInfo(xxlJobInfo);
    } catch (Exception e) {
      e.printStackTrace();
                return new Result(Constant.FAIL_, Constant.ADD_MESSAGE_FAIL, null);
    }
  ...
  public Result deleteByIds(@RequestBody String ids) {
    try {
      return xxlJobInfoService.deleteByIds(ids);
    } catch (Exception e) {
      e.printStackTrace();
                return new Result(Constant.FAIL_, Constant.ADD_MESSAGE_FAIL, null);
    }
  ...
  @ResponseBody
  @RequestMapping("/list")
  public PageResult list(@RequestBody XxlJobInfo xxlJobInfo) {
    try {
      return xxlJobInfoService.list(xxlJobInfo);
    } catch (Exception e) {
