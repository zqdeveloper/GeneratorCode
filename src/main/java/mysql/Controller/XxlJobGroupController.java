...
public class XxlJobGroupController {
  ...
  public Result insert(@RequestBody XxlJobGroup xxlJobGroup) {
    try {
      return xxlJobGroupService.insertXxlJobGroup(xxlJobGroup);
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public Result update(@RequestBody XxlJobGroup xxlJobGroup) {
    try {
      return xxlJobGroupService.updateXxlJobGroup(xxlJobGroup);
    } catch (Exception e) {
      e.printStackTrace();
                return new Result(Constant.FAIL_, Constant.ADD_MESSAGE_FAIL, null);
    }
  ...
  public Result deleteByIds(@RequestBody String ids) {
    try {
      return xxlJobGroupService.deleteByIds(ids);
    } catch (Exception e) {
      e.printStackTrace();
                return new Result(Constant.FAIL_, Constant.ADD_MESSAGE_FAIL, null);
    }
  ...
  @ResponseBody
  @RequestMapping("/list")
  public PageResult list(@RequestBody XxlJobGroup xxlJobGroup) {
    try {
      return xxlJobGroupService.list(xxlJobGroup);
    } catch (Exception e) {
