...
public class SysIpController {
  ...
  public Result insert(@RequestBody SysIp sysIp) {
    try {
      return sysIpService.insertSysIp(sysIp);
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public Result update(@RequestBody SysIp sysIp) {
    try {
      return sysIpService.updateSysIp(sysIp);
    } catch (Exception e) {
      e.printStackTrace();
                return new Result(Constant.FAIL_, Constant.ADD_MESSAGE_FAIL, null);
    }
  ...
  public Result deleteByIds(@RequestBody String ids) {
    try {
      return sysIpService.deleteByIds(ids);
    } catch (Exception e) {
      e.printStackTrace();
                return new Result(Constant.FAIL_, Constant.ADD_MESSAGE_FAIL, null);
    }
  ...
  @ResponseBody
  @RequestMapping("/list")
  public PageResult list(@RequestBody SysIp sysIp) {
    try {
      return sysIpService.list(sysIp);
    } catch (Exception e) {
